...
if __name__ == '__main__':
    for variable in ['precip_data', 'wind_data', 'wave_data']:
        ...
        # test first
        marginals, params = tf_utils.probability_integral_transform(test, evt_type='block-maxima')
        ...
        # train set
        marginals, params = tf_utils.probability_integral_transform(train, evt_type='block-maxima')
